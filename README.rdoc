...
If you run "pry" from the application’s directory you’ll have access to your application’s models just as you would in the standard Rails console. Also you’ll have access to console helpers, for example "reload!". See pryrc file for details.
